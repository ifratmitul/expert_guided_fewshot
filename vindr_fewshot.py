...
class Config:
    ...
    CSV_LABELS = '/dataset/train.csv'
    CSV_BBOXES = CSV_LABELS  # same CSV file
    IMG_SIZE = 224
    BATCH_SIZE = 16
    ALPHA = 0.01  # weight for explanation loss
    NUM_EPOCHS = 5
...
def run_pipeline():
    ...
    n_episodes = 50  # Number of episodes per epoch
    ...
    model, prototypes = train_prototypical_model(train_episodes, test_loader)
